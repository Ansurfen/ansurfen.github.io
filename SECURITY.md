...
2. **Report the issue privately.** 📨
   - Please email us at: [<!-- email -->](<!-- email -->) or use our secure issue reporting system on [our GitHub repository](https://github.com/Ansurfen/ansurfen.github.io/security).
...
- [Security Advisories](https://github.com/Ansurfen/ansurfen.github.io/security/advisories)
